...
# Домашняя работа 35.2 CI/CD и GitHub Actions
___
...
- Склонируйте репозиторий и заполните .env файл с помощью шаблон .env.example и затем разместите проект на своём репозитории
...
- Склонируйте репозиторий и заполните .env файл с помощью шаблон .env.example и затем в консоле введите команду `docker-compose up -d --build`
